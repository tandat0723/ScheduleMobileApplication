...
public class CustomAdapterStatistical extends ArrayAdapter<Schedule> {
    private Context context;
    private List<Schedule> list;
    private MyDatabase myDatabase;

    public CustomAdapterStatistical(Context context, List<Schedule> list, MyDatabase myDatabase) {
